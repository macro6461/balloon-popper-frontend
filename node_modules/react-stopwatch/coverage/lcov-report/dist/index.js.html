...
&nbsp;
    var _this = _possibleConstructorReturn(this, (StopWatch.__proto__ || <span class="branch-1 cbranch-no" title="branch not covered" >Object.getPrototypeOf(StopWatch))</span>.call(this, props));
&nbsp;
...
&nbsp;
  _createClass(StopWatch, [{
    ...
    value: function <span class="fstat-no" title="function not covered" >componentWillReceiveProps(</span>) {
<span class="cstat-no" title="statement not covered" >      this.intervalId = setInterval(<span class="fstat-no" title="function not covered" >fu</span>nction () {}, Number.MAX_VALUE);</span>
...
<span class="cstat-no" title="statement not covered" >      this.stopToCount();</span>
    }
  }, {
    key: 'stopToCount',
    value: function <span class="fstat-no" title="function not covered" >stopToCount(</span>) {
      var _props = <span class="cstat-no" title="statement not covered" >this.props,</span>
          hours = <span class="cstat-no" title="statement not covered" >_props.hours,</span>
          minutes = <span class="cstat-no" title="statement not covered" >_props.minutes,</span>
          seconds = <span class="cstat-no" title="statement not covered" >_props.seconds;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      clearInterval(this.intervalId);</span>
&nbsp;
      var text = <span class="cstat-no" title="statement not covered" >(0, _utils.fillTextWithFormat)(hours, minutes, seconds);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.setState({</span>
        text: text,
        stateHours: hours,
...
&nbsp;
      ...
      <span class="missing-if-branch" title="if path not taken" >I</span>if (stateSeconds &gt;= 60) {
<span class="cstat-no" title="statement not covered" >        this.setState(<span class="fstat-no" title="function not covered" >fu</span>nction (prevState) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (stateMinutes &gt;= 60) {</span>
<span class="cstat-no" title="statement not covered" >          this.setState(<span class="fstat-no" title="function not covered" >fu</span>nction (prevState) {</span>
<span class="cstat-no" title="statement not covered" >            return {</span>
              stateMinutes: 0,
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (limit === text) {
<span class="cstat-no" title="statement not covered" >        this.stopToCount();</span>
<span class="cstat-no" title="statement not covered" >        if (withLoop) {</span>
<span class="cstat-no" title="statement not covered" >          this.timer();</span>
        }
...
StopWatch.defaultProps = {
  ...
  theme: 'primary',
  withLoop: false,
  onCallback: function <span class="fstat-no" title="function not covered" >onCallback(</span>) {}
};
exports.default = (0, _radium2.default)(StopWatch);</pre></td></tr>
</table></pre>
<div class='push'></div><!-- for sticky footer -->
</div><!-- /wrapper -->
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Thu Apr 05 2018 03:20:00 GMT-0300 (-03)
</div>
</div>
